...
time tools/s3-parallel-put --quiet --bucket_region=$AWS_DEFAULT_REGION --processes=64 --put=stupid --bucket=${AWS_BUCKET:-mongooseim-ct-results} --prefix=${CT_REPORTS} ${CT_REPORTS}
