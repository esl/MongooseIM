...
sendtoomuch(Config) ->
    escalus:story(
        ...
        fun(Alice, Bob) ->
            message_is_delivered(Alice, Bob, <<"1">>),
            message_is_delivered(Alice, Bob, <<"2">>),
            message_is_delivered(Alice, Bob, <<"3">>),
            message_is_delivered(Alice, Bob, <<"4">>),
            message_is_delivered(Alice, Bob, <<"5">>),
            message_is_delivered(Alice, Bob, <<"6">>),
            message_is_delivered(Alice, Bob, <<"7">>),
            message_is_delivered(Alice, Bob, <<"8">>),
            message_is_delivered(Alice, Bob, <<"9">>),
            message_is_delivered(Alice, Bob, <<"10">>),
