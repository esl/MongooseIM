...
-spec handle_get_prefs(ejabberd:jid(), IQ :: jlib:iq()) ->
                              jlib:iq() | {error, term(), jlib:iq()}.
...
-spec handle_purge_multiple_messages(ejabberd:jid(), IQ :: jlib:iq()) ->
                                            jlib:iq() | {error, term(), jlib:iq()}.
...
-spec handle_purge_single_message(ejabberd:jid(), IQ :: jlib:iq()) ->
                                         jlib:iq() | {error, term(), jlib:iq()}.
