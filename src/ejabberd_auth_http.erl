...
-spec check_password(jlib:luser(), jlib:lserver(), binary(), binary(), fun()) -> boolean().
...
-spec set_password(jlib:luser(), jlib:lserver(), binary()) -> ok | {error, not_allowed}.
...
-spec try_register(jlib:luser(), jlib:lserver(), binary()) ->
...
-spec get_vh_registered_users_number(jlib:lserver(), list()) -> 0.
...
-spec get_password_s(jlib:luser(), jlib:lserver()) -> binary().
...
-spec remove_user(jlib:luser(), jlib:lserver(), binary()) ->
