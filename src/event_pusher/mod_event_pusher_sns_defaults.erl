...
%% -------------------------------------------------------------------
-spec user_guid(UserJID :: jlib:jid()) -> mod_event_pusher_sns:user_guid().
...
%% -------------------------------------------------------------------
-spec message_attributes(TopicARN :: mod_event_pusher_sns:topic_arn(), UserJID :: jlib:jid(),
...
%% -------------------------------------------------------------------
-spec message_attributes(TopicARN :: mod_event_pusher_sns:topic_arn(), From :: jlib:jid(),
                         To :: jlib:jid(), MessageType :: pm | muc, Packet :: exml:element()) ->
