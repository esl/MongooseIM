...
-type change_aff_success() :: {ok, NewAffUsers :: aff_users(), ChangedAffUsers :: aff_users(),
                               ...
                               LeavingUsers :: [jlib:simple_bare_jid()]}.
...
-spec room_limit_reached(UserUS :: jlib:simple_bare_jid(), RoomS :: jlib:lserver()) ->
    boolean().
...
-spec filter_out_prevented(FromUS :: jlib:simple_bare_jid(),
...
-spec room_limit_reached(UserUS :: jlib:simple_bare_jid(),
                         RoomS :: jlib:lserver(),
...
-spec filter_out_loop(FromUS :: jlib:simple_bare_jid(),
                      MUCServer :: jlib:lserver(),
                      BlockingQuery :: [{blocking_what(), jlib:simple_bare_jid()}],
...
-spec apply_aff_users_change(AffUsers :: aff_users(),
                             ...
                             NewOwner :: new_owner_flag(),
                             JoiningAcc :: [jlib:simple_bare_jid()],
                             LeavingAcc :: [jlib:simple_bare_jid()]) ->
    change_aff_success() | {error, bad_request}.
