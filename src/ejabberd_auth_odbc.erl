...
-spec check_password_wo_escape(LUser::jlib:luser(),
                               LServer::jlib:lserver(),
...
-spec get_password_s(LUser :: jlib:user(),
                     LServer :: jlib:server()) -> binary().
...
-spec prepare_password(Server :: jlib:server(), Password :: binary()) ->
