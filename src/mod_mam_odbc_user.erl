...
%% API
%%====================================================================
-spec archive_id(undefined | mod_mam:archive_id(), jlib:server(),
                 jlib:jid()) -> mod_mam:archive_id().
...
-spec query_archive_id(jlib:server(), jlib:lserver(), jlib:user()) -> integer().
query_archive_id(Host, Server, UserName) ->
    SServer   = mongoose_rdbms:escape(Server),
    SUserName = mongoose_rdbms:escape(UserName),
...
-spec create_user_archive(jlib:server(), jlib:lserver(), jlib:user()) -> 'ok'.
create_user_archive(Host, Server, UserName) ->
    SServer   = mongoose_rdbms:escape(Server),
    SUserName = mongoose_rdbms:escape(UserName),
    Res =
