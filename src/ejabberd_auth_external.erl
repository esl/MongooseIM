...
-spec check_cache_last_options(Server :: jlib:server()
                              ) -> 'cache' | 'no_cache'.
...
-spec get_vh_registered_users(LServer :: jlib:lserver()) -> [jlib:simple_bare_jid()].
...
-spec does_user_exist(LUser :: jlib:luser(),
                     LServer :: jlib:lserver()) -> boolean() | {error, atom()}.
...
-spec remove_user(User :: jlib:luser(),
                  Server :: jlib:lserver()
                  ) -> ok | {error, not_allowed}.
...
-spec get_cache_option(Host :: jlib:lserver()
...
-spec check_password_extauth(LUser :: jlib:luser(),
                             LServer :: jlib:lserver(),
                             Password :: binary()) -> boolean().
...
-spec try_register_extauth(LUser :: jlib:luser(),
                           LServer :: jlib:lserver(),
                           Password :: binary()) -> ok | {error, not_allowed}.
...
-spec check_password_cache(LUser :: jlib:luser(),
                           LServer :: jlib:lserver(),
                           Password :: binary(),
...
-spec get_password_cache(LUser :: jlib:luser(),
                         LServer :: jlib:lserver(),
...
-spec try_register_external_cache(LUser :: jlib:luser(),
                                  LServer :: jlib:lserver(),
                                  Password :: binary()) -> ok | {error, not_allowed}.
...
-spec check_password_internal(LUser :: jlib:luser(),
                              LServer :: jlib:lserver(),
                              Password :: binary()) -> boolean().
check_password_internal(LUser, LServer, Password) ->
...
-spec set_password_internal(LUser :: jlib:luser(),
                            LServer :: jlib:lserver(),
...
-spec get_last_access(User :: jlib:user(),
                      Server :: jlib:server()
...
-spec get_last_info(User :: jlib:user(),
                    Server :: jlib:server()
...
-spec get_mod_last_configured(Server :: jlib:server()
