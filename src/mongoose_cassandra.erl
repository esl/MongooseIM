...
%% --------------------------------------------------------
-spec cql_write(PoolName :: pool_name(), UserJID :: jlib:jid(), Module :: atom(),
...
%% --------------------------------------------------------
-spec cql_write_async(PoolName :: pool_name(), UserJID :: jlib:jid(), Module :: atom(),
                      QueryName :: query_name(), Rows :: [parameters()]) ->
                             ok | {error, Reason :: any()}.
...
%% --------------------------------------------------------
-spec cql_read(PoolName :: pool_name(), UserJID :: jlib:jid() | undefined, Module :: atom(),
