...
-spec select_room_id(RoomU :: jlib:luser(), RoomS :: jlib:lserver()) -> iolist().
...
-spec insert_room(
        RoomU :: jlib:luser(), RoomS :: jlib:lserver(), Version :: binary()) -> iolist().
...
-spec delete_room(RoomU :: jlib:luser(), RoomS :: jlib:lserver()) -> iolist().
...
-spec select_affs(RoomU :: jlib:luser(), RoomS :: jlib:lserver()) -> iolist().
...
-spec insert_aff(RoomID :: integer() | binary(), UserU :: jlib:luser(),
                 UserS :: jlib:lserver(), Aff :: aff()) -> iolist().
...
-spec update_aff(RoomID :: integer() | binary(), UserU :: jlib:luser(),
                 UserS :: jlib:lserver(), Aff :: aff()) -> iolist().
...
-spec delete_aff(RoomID :: integer() | binary(), UserU :: jlib:luser(),
                 UserS :: jlib:lserver()) ->
    iolist().
...
-spec select_config(RoomU :: jlib:luser(), RoomS :: jlib:lserver()) -> iolist().
...
-spec select_config(RoomU :: jlib:luser(), RoomS :: jlib:lserver(), Key :: binary()) ->
    iolist().
...
-spec select_blocking(LUser :: jlib:luser(), LServer :: jlib:lserver()) -> iolist().
select_blocking(LUser, LServer) ->
    ["SELECT what, who FROM muc_light_blocking WHERE luser = '", ?ESC(LUser), "'",
                                               " AND lserver = '", ?ESC(LServer), "'"].

-spec select_blocking_cnt(LUser :: jlib:luser(), LServer :: jlib:lserver(),
                           WhatWhos :: [{blocking_who(), jlib:simple_bare_jid()}]) -> iolist().
...
-spec insert_blocking(LUser :: jlib:luser(), LServer :: jlib:lserver(),
...
-spec delete_blocking(LUser :: jlib:luser(), LServer :: jlib:lserver(),
                         What :: blocking_what(), Who :: blocking_who()) -> iolist().
...
-spec delete_blocking(UserU :: jlib:luser(), UserS :: jlib:lserver()) -> iolist().
