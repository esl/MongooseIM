...
init([]) ->
    ...
    DiscoFile = filename:join(ConfigDir, "kiss_disco.txt"),
    DiscoOpts = #{name => mongoose_kiss_discovery, disco_file => DiscoFile},
    KissDisco =
        {kiss_discovery,
          {kiss_discovery, start_link, [DiscoOpts]},
          permanent, infinity, supervisor, [kiss_discovery]},
    {ok, {{one_for_one, 10, 1},
          [KissDisco,
           PG,
           Hooks,
