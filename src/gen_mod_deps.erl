...
-spec start_modules(Host :: jlib:server(), Modules :: gen_mod_list()) -> ok.
...
%% @end
-spec replace_modules(Host :: jlib:server(), OldModules :: gen_mod_list(),
...
%% @end
-spec resolve_deps(Host :: jlib:server(), Modules :: gen_mod_list()) ->
                          gen_mod_map().
...
-spec sort_deps(Host :: jlib:server(), ModuleMap :: gen_mod_map()) ->
                       gen_mod_list().
...
-spec process_module_dep(Host :: jlib:server(), Module :: module(),
                         Args :: gen_mod_params(),
