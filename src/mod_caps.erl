...
-spec user_send_packet(mongoose_acc:t(), ejabberd:jid(), ejabberd:jid(), exml:element()) -> mongoose_acc:t().
...
-spec user_receive_packet(mongoose_acc:t(), ejabberd:jid(), ejabberd:jid(), ejabberd:jid(), exml:element()) -> mongoose_acc:t().
...
-spec feature_request(mongoose_acc:t(), ejabberd:server(), ejabberd:jid(), caps(), [binary()]) ->
    mongoose_acc:t().
...
-spec feature_response(mongoose_acc:t(), jlib:iq(), ejabberd:server(), ejabberd:jid(), caps(), [binary()]) ->
    mongoose_acc:t().
