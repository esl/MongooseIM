...
-spec get_tls_last_message(peer | owner, ejabberd_socket:socket()) -> {ok, binary()} | binary().
get_tls_last_message(Peer, #ejabberd_tls_socket{} = Socket) ->
