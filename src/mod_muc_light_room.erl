...
-spec maybe_forget(RoomUS :: jlib:simple_bare_jid(), NewAffUsers :: aff_users()) -> any().
...
-spec participant_limit_check(RoomUS :: jlib:simple_bare_jid(),
...
-spec send_response(From :: jlib:jid(), RoomJID :: jlib:jid(),
                    RoomUS :: jlib:simple_bare_jid(), OrigPacket :: exml:element(),
