...
-record(muc_light_user_room, {
           user :: jlib:simple_bare_jid(),
           room :: jlib:simple_bare_jid()
          }).

-record(muc_light_blocking, {
           user :: jlib:simple_bare_jid(),
           item :: {user | room, jlib:simple_bare_jid()}
          }).
...
-spec get_blocking(UserUS :: jlib:simple_bare_jid(),
                   MUCServer :: jlib:lserver(),
                   WhatWhos :: [{blocking_what(), jlib:simple_bare_jid()}]) ->
    blocking_action().
...
-spec dirty_get_blocking_raw(UserUS :: jlib:simple_bare_jid()) -> [muc_light_blocking()].
...
-spec verify_externally_and_submit(RoomUS :: jlib:simple_bare_jid(),
...
-spec update_users_rooms(RoomUS :: jlib:simple_bare_jid(),
                         JoiningUsers :: [jlib:simple_bare_jid()],
                         LeavingUsers :: [jlib:simple_bare_jid()]) -> ok.
