...
-type host() :: jlib:server() | 'global'.
-type acl_name() :: {atom(), host()}.
-type regexp() :: iolist() | binary().
-type aclspec() :: all
                | none
                | {user, jlib:user()}
                | {user, jlib:user(), jlib:server()}
                | {server, jlib:server()}
                | {resource, jlib:resource()}
                | {user_regexp, regexp()}
                | {user_regexp, regexp(), jlib:server()}
                | {server_regexp, regexp()}
                | {resource_regexp, regexp()}
                | {node_regexp, regexp(), regexp()}
                | {user_glob, regexp()}
                | {user_glob, regexp(), jlib:server()}
                | {server_glob, regexp()}
...
-spec is_server_valid(host(), jlib:server()) -> boolean().
...
-spec match(aclspec(), jlib:simple_jid(), host()) -> boolean().
