...
publish_item(Nidx, Publisher, Model, MaxItems, ItemId, ItemPublisher, Payload) ->
    node_flat:publish_item(Nidx, Publisher, Model, MaxItems, ItemId, ItemPublisher, Payload).
