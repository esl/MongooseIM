...
!!! Note
    Some access rules are checked outside of the context of any domain, e.g. the [access rule for external components](../listeners/listen-components.md#listencomponentaccess) - defining them in `host_config` would have no effect.
