...
=== "Prometheus"
    ...
    | `tls_cert_remaining_days` | gauge | Certificate remaining validity in days: -32768 - invalid certificate, -32767 - not yet valid, otherwise days to expiry (negative indicates expired) |
...
=== "Exometer"
    ...
    | `[global, tls_cert_remaining_days, ListenerId, count]` | gauge | Certificate remaining validity in days: -32768 - invalid certificate, -32767 - not yet valid, otherwise days to expiry (negative indicates expired) |
