...
](https://www.erlang-solutions.com/products/megaload.html), another Erlang Solutions' tool that enables devs and ops to validate their scalability, given the clients scenarios.
