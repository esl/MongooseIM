## Push notifications with PubSub

Server side push notification support described below is fully compliant with [XEP-0357 Push Notifications][XEP-0357],
which defines several components that need to work together in order to provide clients with working push notifications.
