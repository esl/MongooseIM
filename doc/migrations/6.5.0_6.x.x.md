...
As part of the BOSH and WebSocket refactor, we have updated the names of BOSH and WebSocket metrics, dropping the `mod_` prefix. See the [document about metrics](../operation-and-maintenance/MongooseIM-metrics.md#network-data-metrics) for details.
