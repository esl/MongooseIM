...
* The default value of the [`backlog`](../configuration/listen-general.md#listenbacklog) option for all XMPP listeners has been increased from 100 to 1024 for performance reasons.
* You might be interested in the new C2S listener options: [`max_connections`](../configuration/listen-c2s.md#listenc2smax_connections), [`c2s_state_timeout`](../configuration/listen-c2s.md#listenc2sc2s_state_timeout), [`reuse_port`](../configuration/listen-c2s.md#listenc2sreuse_port) and [`backwards_compatible_session`](../configuration/listen-c2s.md#listenc2sbackwards_compatible_session). The first two options can be set for [websockets](../configuration/listen-http.md#handler-types-websockets-mod_websockets) as well.
