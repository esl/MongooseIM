...
* You might be interested in the new C2S listener options. The first two options can be set for websockets as well.
    * `max_connections`
    * `c2s_state_timeout`
    * `reuse_port`
    * [`backwards_compatible_session`](../listeners/listen-c2s.md#listenc2sbackwards_compatible_session)
