...
The [`legacy_mode`](../modules/mod_muc_light.md) option of `mod_muc_light`, which enables the legacy XEP-0045 compatibility codec, is now deprecated and will be removed in the next release.
