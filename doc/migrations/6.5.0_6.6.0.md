...
Starting from this release it is removed from the codebase.
...
Since the introduction of GraphQL API this feature was deprecated. Starting from this release it is removed from the codebase.
...
| --- | --- | --- |
| `wpool_rabbit_connections` | `wpool_global_rabbit_connections` | `pool_tag` |
| `wpool_rabbit_messages_published` | `wpool_global_rabbit_messages_published` | `pool_tag` |
