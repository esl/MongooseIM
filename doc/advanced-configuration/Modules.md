...
For instance `mod_muc` enables Multi-User Chat (group chat), `mod_mam` gives us Message Archive Management, and `mod_stream_management` is for stanza acknowledgements and stream resumption. 
...
It defines the method of handling incoming IQ stanzas. 
...
This applies to situations such as sending messages or presences to mobile/SMS/email push service, big data, or analytics service.
...
It is tightly coupled with users' presences in chat rooms.
