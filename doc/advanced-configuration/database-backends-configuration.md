...
The required minimum version of MySQL is `5.5.14`. If you are using a version older than `5.7.6`, add the following options to your MySQL configuration file:
