...
The following options are supported for each component listener under `listen.component` subsection (apart from the [general](../configuration/listen.md#general-listener-options) and [XMPP](../configuration/listen.md#xmpp-listener-options) ones):
