...
-record(pubsub_state,
{
    stateid               ,% :: {ejabberd::ljid(), mod_pubsub:nodeIdx()},
...
-record(pubsub_item,
{
    ...
    creation     = {unknown, unknown},% :: {erlang:timestamp(), ejabberd::ljid()},
    modification = {unknown, unknown},% :: {erlang:timestamp(), ejabberd::ljid()},
