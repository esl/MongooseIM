...
basic_groups() ->
    [
     ...
     {disabled_message_retraction, [],
         [
          {mam04, [], disabled_retract_cases()},
          {muc04, [], disabled_muc_retract_cases()}
         ]}
    ].
...
addin_mam_options(disabled_message_retraction, Config) ->
...
message_should_be_retracted(Config) ->
    ?config(basic_group, Config) =/= disabled_message_retraction
